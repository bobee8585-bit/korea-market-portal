...
export default function HomePage() {
  return (
    <main className="shell">
      ...
      <DirectSponsorSlot />
      <a className="industryHomeFeature" href="/industries"><div><span className="eyebrow">BEYOND THE HEADLINES</span><h2>Ten connected manufacturing sectors.</h2><p>Follow food, chemicals, refining, steel, biohealth, machinery, defense, cosmetics, displays and batteries from inputs to global markets—with every major claim tied to evidence.</p></div><strong>Open the industry map →</strong></a>
