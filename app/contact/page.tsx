...
export default function Page() {
  ...
  return <InfoPage eyebrow="CONTACT" title="Contact KorPulse." intro="Send corrections, rights questions, source suggestions or commercial enquiries with enough detail for review.">
    ...
    <h2>Advertising enquiries</h2><p>Include the organisation name, website, campaign dates, target market and industry category. Advertising does not purchase editorial influence.</p>
  </InfoPage>;
}
