...
export default function Page() {
  return <InfoPage eyebrow="PRIVACY" title="Privacy by staged activation." intro="Effective 16 August 2026. This notice explains the current service and how future advertising tools will be activated.">
    ...
    <h2>Advertising</h2><p>Direct sponsorship measurement records the campaign, placement, page and event type without cookies or persistent user identifiers. Third-party advertising scripts remain disabled until the relevant provider is approved and consent requirements are implemented.</p>
