...
export default async function GlobalMoneyPage() {
  ...
  return <main className="shell">
    ...
    <a className="fundFlowInlineCta" href="/fund-flow"><div><span className="eyebrow">MARKET POSITIONING</span><h2>KOSPI Fund Flow Monitor</h2><p>Cross-check foreign flows, derivatives, short activity, leveraged products and index concentration.</p></div><strong>Open assessment →</strong></a>
    ...
    {items.length === 0 && <OfficialSourceHub section="globalMoney" />}
  </main>;
}
