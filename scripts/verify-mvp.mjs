...
for (const company of ["CJ CheilJedang", "Samyang Corporation", "Daesang Corporation", "LG Chem", "LOTTE Chemical", "GS Caltex", "S-OIL", "Hyundai Steel", "Celltrion", "SK bioscience"]) if (!industryCompanyEvidence.includes(company)) failures.push(`Official ingredient evidence is missing ${company}.`);
