...
const footerLinks = [
  ...
  ["/industries", "Industries"], ["/editorial-policy", "Editorial Policy"], ["/corrections", "Corrections & Rights"], ["/translation-policy", "Translation Policy"], ["/disclaimer", "Disclaimer"], ["/privacy", "Privacy"], ["/terms", "Terms"], ["/contact", "Contact"],
] as const;
